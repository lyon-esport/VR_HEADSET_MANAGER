@{
    ...
    PressEnterToContinue = "Appuyez sur Entree pour continuer"
    ...
    WebServerStarted = "Serveur web demarre sur le port {0} (PID {1})"
    WebServerStopped = "Serveur web arrete (PID {0})"
    ...
    Kiosk = @{
        ...
        ActionInfo          = "  I. Infos machine (kiosks avances)"
        ActionReboot        = "  R. Redemarrer le PC kiosk (kiosks avances)"
        ...
        ScanColumnDevice    = "Machine"

        # Kiosks avances (Start-KioskAgent.ps1 / Start-KioskAgent-Linux.sh).
        # Un kiosk basique (v1) ne se signale jamais : ces champs restent vides.
        AgentBadge          = "[v2]"
        AgentNone           = "Ce kiosk utilise le lanceur basique et ne remonte aucune information machine."
        AgentNoneHint       = "Lancez Start-KioskAgent sur le PC kiosk pour activer les infos machine et le controle d'alimentation a distance."
        AgentStale          = "ATTENTION : ce kiosk ne se signale plus - les valeurs ci-dessous peuvent etre obsoletes."
        InfoTitle           = "=== INFOS MACHINE DU KIOSK : {0} ==="
        InfoComputer        = "Nom machine   : {0}"
        InfoOS              = "Systeme       : {0}"
        InfoLink            = "Lien reseau   : {0}"
        InfoBrowser         = "Navigateur    : {0}"
        InfoAgent           = "Version agent : {0}"
        InfoUptime          = "Duree agent   : {0}"
        InfoLastReport      = "Dernier envoi : {0}"
        InfoCurrentUrl      = "Affiche       : {0}"
        PowerNotAdvanced    = "Le kiosk '{0}' n'utilise pas le lanceur avance - controle d'alimentation indisponible."
        PowerRebootConfirm  = "REDEMARRER le PC kiosk '{0}' ? (O/N) : "
        PowerShutdownConfirm = "ETEINDRE le PC kiosk '{0}' ? Il ne pourra etre rallume que physiquement. (O/N) : "
        PowerCancelled      = "Action d'alimentation annulee."
