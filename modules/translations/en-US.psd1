@{
    ...
    WebServerAlreadyRunning = "Web server already running on port {0} (PID {1})"
    WebServerStale = "Web server PID {0} is no longer serving on port {1} - relaunching"
    WebServerLinksHeader = "Web monitor available at:"
    WebServerLinkLine    = "  http://{0}:{1}/ {2}"
    WebServerStarted = "Web server started on port {0} (PID {1})"
    WebServerStopped = "Web server stopped (PID {0})"
    ...
    # ==========================================
    # Kiosk Screens (console_manager.ps1 - Show-SubMenu-KioskScreens)
    # NOTE: nested under one top-level key on purpose. Import-PowerShellDataFile
    # enforces a hard 500 key/value-pair limit on a single hashtable literal;
    # the en-US.psd1 top-level table was already close to that limit, so all
    # Kiosk strings live under $msg.Kiosk.* instead of flat top-level keys.
    # ==========================================
    Kiosk = @{
        MenuOption          = " K. Kiosk Screens management "
        ScreensTitle        = "=== KIOSK SCREENS ==="
        NoKiosksFound       = "No kiosk screens registered yet."
        StatusOK            = "OK"
        StatusCdpClosed     = "Reachable, CDP closed"
        StatusUnreachable   = "Unreachable"
        MenuAdd             = "  A. Add kiosk manually"
        MenuScan            = "  S. Scan network for kiosks"
        MenuSelectRow       = "  [1-{0}]. Manage a kiosk"
        MenuBack            = "  0. Back to main menu"
        Selected            = "Selected"
        ActionPush          = "  P. Push URL"
        ActionEdit          = "  E. Edit (Name/IP/Port)"
        ActionInfo          = "  I. Device info (advanced kiosks)"
        ActionReboot        = "  R. Reboot the kiosk PC (advanced kiosks)"
        ...
        PushSuccess         = "URL pushed successfully to kiosk {0}."
        PushFailed          = "Failed to push URL to kiosk {0}: {1}"
        EditFieldName       = "1. Name"
        EditFieldIP         = "2. IPAddress"
        EditFieldPort       = "3. Port"
        EditFieldPrompt     = "Select field to edit"
        EditNewValuePrompt  = "Enter new value for {0} (current: {1}): "
        EditSuccess         = "Kiosk {0} updated."
        DeleteConfirm       = "Delete kiosk '{0}'? (Y/N): "
        DeleteSuccess       = "Kiosk '{0}' deleted."
        DeleteCancelled     = "Deletion cancelled."
        AddIPPrompt         = "Kiosk IP address (mandatory): "
        AddIPInvalid        = "IP address is mandatory. Aborting."
        AddNamePrompt       = "Kiosk name (optional, defaults to IP): "
        AddPortPrompt       = "Kiosk port (default 9222): "
        AddPortInvalid      = "Invalid port number. Using default 9222."
        AddSuccess          = "Kiosk '{0}' added."
        InvalidChoice       = "Invalid choice."
        ScanTitle           = "=== NETWORK SCAN FOR KIOSKS ==="
        ScanNoNetworks      = "No private network detected."
        ScanSelectInterface = "Select a network interface (1-{0}): "
        ScanScanning        = "Scanning network {0} for kiosk screens..."
        ScanNoneFound       = "No kiosk screens detected on the network."
        ScanResultsHeader   = "Detected devices:"
        ScanAlreadyAdded    = "(already added)"
        ScanSelectPrompt    = "Enter the numbers of devices to add (e.g.: 1,3,5): "
        ScanNoneSelected    = "No device selected."
        ScanConfirm         = "Confirm adding these kiosks? (Y/N): "
        ScanCancelled       = "Addition cancelled."
        ScanNamePrompt      = "Friendly name for {0} (optional): "
        ScanAddSuccess      = "Kiosk(s) added successfully."
        ScanColumnDevice    = "Device"

        # Advanced kiosks (Start-KioskAgent.ps1 / Start-KioskAgent-Linux.sh).
        # A basic (v1) kiosk never reports itself, so these stay empty for it.
        AgentBadge          = "[v2]"
        AgentNone           = "This kiosk runs the basic launcher and does not report device information."
        AgentNoneHint       = "Run Start-KioskAgent on the kiosk PC to enable device info and remote power control."
        AgentStale          = "WARNING: this kiosk stopped reporting - the values below may be out of date."
        InfoTitle           = "=== KIOSK DEVICE INFO: {0} ==="
        InfoComputer        = "Computer name : {0}"
        InfoOS              = "Operating sys.: {0}"
        InfoLink            = "Network link  : {0}"
        InfoBrowser         = "Browser       : {0}"
        InfoAgent           = "Agent version : {0}"
        InfoUptime          = "Agent uptime  : {0}"
        InfoLastReport      = "Last report   : {0}"
        InfoCurrentUrl      = "Showing now   : {0}"
        PowerNotAdvanced    = "Kiosk '{0}' does not run the advanced launcher - remote power control is unavailable."
        PowerRebootConfirm  = "REBOOT the kiosk PC '{0}'? (Y/N): "
        PowerShutdownConfirm = "SHUT DOWN the kiosk PC '{0}'? It can only be powered back on physically. (Y/N): "
        PowerCancelled      = "Power action cancelled."
