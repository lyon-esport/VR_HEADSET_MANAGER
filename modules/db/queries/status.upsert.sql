...
-- battery_history TABLE, written by the trigger this statement fires.
INSERT INTO headset_status (headset_id, ping, adb_wifi, battery, charging,
       ...
       power_state, time_remaining_min, scrcpy, running_app,
...
VALUES (@ID, @Ping, @ADBWifi, @Battery, @Charging,
        ...
        @PowerState, @TimeRemainingMin, @SCRCPY, @RunningApp,
