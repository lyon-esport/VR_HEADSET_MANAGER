// App Launcher modal - shared between video_monitor.html and [video].html pages
// Exposes window.openLaunchModal(displayName) globally.
(function () {
  // ---- Inject CSS ----
  var style = document.createElement('style');
  style.textContent = [
    '.app-launcher{position:fixed;inset:0;z-index:200;background:rgba(0,0,0,0.72);display:flex;align-items:flex-start;justify-content:center;}',
    ...
    '.lm-launch-btn{display:inline-flex;align-items:center;gap:5px;padding:3px 10px;border-radius:5px;border:1px solid #2a4a7a;background:rgba(59,130,246,0.1);color:#3b82f6;font-size:11px;font-weight:700;cursor:pointer;font-family:inherit;flex-shrink:0;transition:background 0.12s,border-color 0.12s;}',
    ...
    '[data-theme="light"] .app-launcher{background:rgba(0,0,0,0.38);}',
    '[data-theme="light"] .app-launcher-box{background:#fff;border-color:#e5e5e5;box-shadow:0 8px 32px rgba(0,0,0,0.18);}',
